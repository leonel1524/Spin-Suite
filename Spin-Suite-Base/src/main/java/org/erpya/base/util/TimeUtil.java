 ...
 *	@author Yamel Senih Copied from ADempiere
 */
public class TimeUtil {
	...
	static public Date getDay (long time) {
		...
		GregorianCalendar cal = new GregorianCalendar(org.erpya.base.util.Language.getLoginLanguage().getLocale());
	 ...
	 */
	public static int getDaysBetween (Date start, Date end, int... matchingDay) {
		if(start == null
				|| end == null) {
			return 0;
		}
	 ...
	 * @return Date
	 */
	public static Date addYears (Date from, int offset) {
		if(from == null)
			return from;
		GregorianCalendar cal = new GregorianCalendar();
		cal.setTime(from);
	...
	/**
	 * Get Date based on Duration Unit and Duration
	 * @param date
	 * @param durationUnit
	 * @param duration
	 * @return
	 */
	public static Date addDuration(Date date , String durationUnit , BigDecimal duration) {
	 ...
	 * @return
	 */
	public static Date addDuration(Date date , String durationUnit , int duration) {
