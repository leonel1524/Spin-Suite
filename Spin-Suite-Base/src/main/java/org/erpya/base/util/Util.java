...
public class Util
{
	...
	public static String lpadZero(final String value, final int size, final String description) throws Exception {
		if (value == null)
		{
		...
		{
			throw new Exception("value='" + valueFixed + "' of '" + description + "' is bigger than " + size + " characters");
		}
